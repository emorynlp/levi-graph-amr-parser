...
if __name__ == '__main__':
    ...
    parser.add_argument('--propbank_dir', default='data/AMR/amr_annotation_3.0/data/frames/propbank-amr-frames-xml-2018-01-25')
    parser.add_argument('--verbalization_file', default='data/AMR/verbalization-list-v1.06.txt')
    parser.add_argument('--dump_dir', default='amr_3.0_utils')

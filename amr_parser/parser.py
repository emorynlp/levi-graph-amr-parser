...
from amr_parser.encoder import WordEncoder, ConceptEncoder
...
class Parser(nn.Module):
    ...
    def forward(self, data):
        ...
        return concept_loss.mean(), arc_loss.mean(), None if rel_loss is None else rel_loss.mean(), graph_arc_loss.mean()

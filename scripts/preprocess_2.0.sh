...
data_dir=/home/hhe43/hanlp/data/amr/amr_2.0
train_data=${data_dir}/single.txt.features
dev_data=${data_dir}/single.txt.features
test_data=${data_dir}/single.txt.features

# ========== Set the above variables correctly ==========

printf "Cleaning inputs...`date`\n"
python3 -u -m stog.data.dataset_readers.amr_parsing.preprocess.input_cleaner \
...
python3 -u -m stog.data.dataset_readers.amr_parsing.preprocess.sense_remover \
    --util_dir ${util_dir} \

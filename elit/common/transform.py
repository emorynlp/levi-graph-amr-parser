...
from elit.common.io import load_json
from elit.common.reflection import classpath_of, str_to_type
...
class VocabDict(SerializableDict):
    ...
    def __init__(self, *args, **kwargs) -> None:
        """A dict holding :class:`elit.common.vocab.Vocab` instances. When used a transform, it transforms the field

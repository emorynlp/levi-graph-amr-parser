...
from elit.common.visualization import pretty_tree_horizontal, make_table, markdown_table
...
class CoNLLSentence(list):
    def __init__(self, words=None):
        """
        Create from a list of :class:`~elit.common.conll.CoNLLWord` or :class:`~elit.common.conll.CoNLLUWord`
    ...
    def from_str(conll: str, conllu=False):
        ...
        Args:
          ...
          conllu:  ``True`` to build :class:`~elit.common.conll.CoNLLUWord` for each token.

        Returns:
            A :class:`~elit.common.conll.CoNLLSentence`.
        """

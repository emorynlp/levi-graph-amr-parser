...
import torch
from elit.layers.transformers.utils import get_optimizers
...
from elit.datasets.coref.conll12coref import CONLL12CorefDataset
from elit.layers.context_layer import LSTMContextualEncoder
from elit.layers.embeddings.embedding import Embedding
from elit.layers.feed_forward import FeedForward

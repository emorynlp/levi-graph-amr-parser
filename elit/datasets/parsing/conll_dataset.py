...
class CoNLLParsingDataset(TransformableDataset):
    ...
    def __init__(self,
        ...
        Args:
            ...
            generate_idx: Create a :const:`~elit.common.constants.IDX` field for each sample to store its order in dataset. Useful for prediction when
    ...
    def load_file(self, filepath):
        ...
        :class:`elit.common.conll.CoNLLWord` and :class:`elit.common.conll.CoNLLUWord` respectively.
